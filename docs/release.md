...
- **Version 44** `seedExercisesV44` — additive abs rows (`reverseCrunch`, `stomachVacuum`) + variation edges; pair with `supabase/migrations/20260528120100_catalog_reverse_crunch_stomach_vacuum.sql` when Postgres sync is used.
