...
/// default minimum **touch target** height. Dialog buttons use a shorter
/// **layout** minimum ([dialogMinHeight]); [showAthlosDialog] uses
...
abstract final class AthlosButtonSizes {
  ...
  static const double dialogMinHeight = AthlosSpacing.lg; // 24
}
